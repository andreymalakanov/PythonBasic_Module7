...
winers = 0
for tickets in 345, 19, 87, 1020, 421, 1010, 95, 115:
  if (tickets >=100) and (tickets <= 999) and (tickets % 5 == 0):
    winers += 1
    print (tickets, '- счастлиый билет!')
print ('Всего победителей:', winers)